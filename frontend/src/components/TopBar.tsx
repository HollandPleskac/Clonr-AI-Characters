          ...
          >
            <div className='flex mt-5 lg:items-center lg:justify-between lg:mt-0 lg:pl-5 '>
              <div className='flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-start '>
                ...
                <SocialMedia/>
                {/* <div className='order-1 lg:order-0 flex items-end space-x-2  h-[20px] translate-y-[6px]' >
                  <a
                    className='inline-flex justify-center items-center w-8 text-center text-gray-500 rounded-full transition dark:text-[#515151] dark:hover:text-gray-200'
                    href='#'
                  >
                    <svg
                      width='16'
                  ...
                  <a
                    className='inline-flex justify-center items-center w-8 text-center text-gray-500 focus:outline-none transition dark:text-[#515151] dark:hover:text-gray-200'
                    href='#'
                  >
                    <svg
                      width='16'
                      ...
                      xmlns='http://www.w3.org/2000/svg'
                    >
                      <path d='M14.9733 3.99999C14.4599 4.23332 13.9066 4.38666 13.3333 4.45999C13.9199 4.10666 14.3733 3.54666 14.5866 2.87332C14.0333 3.20666 13.4199 3.43999 12.7733 3.57332C12.2466 2.99999 11.5066 2.66666 10.6666 2.66666C9.09994 2.66666 7.81994 3.94666 7.81994 5.52666C7.81994 5.75332 7.84661 5.97332 7.89328 6.17999C5.51994 6.05999 3.40661 4.91999 1.99994 3.19332C1.75328 3.61332 1.61328 4.10666 1.61328 4.62666C1.61328 5.61999 2.11328 6.49999 2.88661 6.99999C2.41328 6.99999 1.97328 6.86666 1.58661 6.66666V6.68666C1.58661 8.07332 2.57328 9.23332 3.87994 9.49332C3.46043 9.60813 3.02001 9.6241 2.59328 9.53999C2.77435 10.1083 3.12897 10.6056 3.60729 10.9619C4.08561 11.3183 4.66358 11.5158 5.25994 11.5267C4.24903 12.3269 2.99594 12.7595 1.70661 12.7533C1.47994 12.7533 1.25328 12.74 1.02661 12.7133C2.29328 13.5267 3.79994 14 5.41328 14C10.6666 14 13.5533 9.63999 13.5533 5.85999C13.5533 5.73332 13.5533 5.61332 13.5466 5.48666C14.1066 5.08666 14.5866 4.57999 14.9733 3.99999Z' />
                    </svg>
                  </a>
                  <a
                    className='inline-flex justify-center items-center w-8 text-center text-gray-500 rounded-full focus:outline-none transition dark:text-[#515151] dark:hover:text-gray-200'
                    href='#'
                  >
                    <svg
                      width='16'
...
{
  /*
   <button className= hover:bg-gray-700 rounded-lg p-2 grid place-items-center transition duration-200'>
          <SearchIcon />
        </button>
         */
}
