...
const Dropdown: React.FC<DropdownProps> = ({ onItemClick, activeSort }) => {
    return (
        <div className="hs-dropdown relative inline-flex flex-grow flex-shrink-0">
            <button id="hs-dropdown-default" type="button" className="text-[#979797] h-[50px] hs-dropdown-toggle py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md font-medium shadow-sm align-middle transition-all text-sm bg-black text-gray-400 border border-gray-700 hover:border-gray-600 active:border-gray-600">
                Sort: {activeSort}
            ...
            <div className="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] hs-dropdown-open:opacity-100 opacity-0 w-[160px] hidden z-10 mt-2 min-w-[160px] bg-white shadow-xl rounded-lg p-2 dark:bg-black dark:border dark:border-gray-700 dark:divide-gray-700" aria-labelledby="hs-dropdown-default">
                <button
