...
# in prod, these requests are made to the nextjs server not the fastapi server
# we can't simulate that with the test client, and it requires spinning up the frontend
# input_data = {
...
# @pytest.fixture(name="creator_headers", scope="function")
# def creator_headers(user_headers) -> dict[str, str]:
#     return user_headers
# # Register user
# r = client.post(
#     "/auth/register",
